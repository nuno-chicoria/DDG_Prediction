...
file = open("/Users/nuno_chicoria/Documents/master_thesis/files/rsa_ss_nn/dataset_7.csv", "w+")

for filepath in glob.iglob("/Users/nuno_chicoria/Documents/master_thesis/files/msa_7/*.npy"):
    ...
    with open("dataset_7.csv", "a") as file:
